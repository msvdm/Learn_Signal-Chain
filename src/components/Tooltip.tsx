  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-2 mb-3">
        <h3 className="text-sm font-semibold text-slate-900 leading-tight">{nodeId.charAt(0).toUpperCase() + nodeId.slice(1)}</h3>
      ...
      <div className="space-y-2 text-xs text-slate-700">
        <div>
          <span className="font-semibold text-slate-500 uppercase tracking-wide text-[10px]">What is this?</span>
          <p className="mt-0.5 leading-relaxed">{entry.what}</p>
        </div>
        <div>
          <span className="font-semibold text-slate-500 uppercase tracking-wide text-[10px]">Why is it here?</span>
          <p className="mt-0.5 leading-relaxed">{entry.why}</p>
        </div>
        <div className="rounded-lg bg-amber-50 border border-amber-100 p-2">
          <span className="font-semibold text-amber-700 uppercase tracking-wide text-[10px]">Pro tip</span>
